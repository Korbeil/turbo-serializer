...
final class SerializerTest extends BundleSetUp
{
    ...
    {
        /** @var Nursery $nursery */
        $nursery = $this->serializer->deserialize(self::JSON, Nursery::class, 'json', [Serializer::DTO_PROXY => NormalizedNursery::class]);
    ...
    public function testSerializeWithProxy(): void
    {
        ...
        $nursery = $this->serializer->serialize($nursery, 'json', [Serializer::DTO_PROXY => NormalizedNursery::class]);
